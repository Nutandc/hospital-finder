...
class StoreResponse implements Responsable
{
    ...
    public function __construct(Parents $model, $password_generated)
    {
        $this->model = $model;
    ...
    public function toResponse($request)
    {
        ...
        if ($this->model) {
            return redirect()->route('parents.index')->with('success', 'Parents added successfully');
        } else {
            return redirect()->back()->withInput()->with('failed', 'Parents cannot be added');
        }
    }
