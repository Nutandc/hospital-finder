...
class ClassRoutineController extends Controller
{
    ...
    public function __construct(Classr $classes)
    {
        ...
        $this->middleware(['permission:class-routine-view|class-routine-create|class-routine-edit|class-routine-delete'], ['only' => ['index', 'show']]);
        $this->middleware(['permission:class-routine-create'], ['only' => ['create', 'store', 'show']]);
        $this->middleware(['permission:class-routine-edit'], ['only' => ['edit', 'update', 'show']]);
