...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">Parent Register</div>
                <div class="card-body">
                    <form method="POST" action="/addparentrole">
                        {{ csrf_field() }}
                        {{ method_field('PUT') }}
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="occupation" type="text" value="{{ old('occupation') }}" class="form-control @error('occupation') is-invalid @enderror" name="occupation" required autocomplete="occupation">
